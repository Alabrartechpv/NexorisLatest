...
namespace PosBranch_Win.Reports.PurchaseReports
{
    ...
    public partial class frmPurchaseReportDetails : Form
    {
        ...
        private void InitializePanels()
        {
            ...
            StyleSummaryLabel(ultraLabelTotalPurchasesCaption, Color.FromArgb(25, 118, 210), true);
            ...
            StyleSummaryLabel(ultraLabelPayedAmountCaption, Color.FromArgb(211, 84, 0), true);

            // Style summary value labels - Large, bold, colorful
            StyleSummaryValueLabel(ultraLabelTotalPurchasesValue, Color.FromArgb(13, 71, 161), 14);
            ...
            StyleSummaryValueLabel(ultraLabelPayedAmountValue, Color.FromArgb(191, 54, 12), 14);
        }
        ...
        private void UpdateGrandTotals()
        {
            try
            {
                ...
                ultraLabelTotalPurchasesValue.Text = totalPurchases.ToString("N0");
                ultraLabelSubTotalValue.Text = $"? {grandSubTotal:N2}";
                ultraLabelGrandTotalValue.Text = $"? {grandTotal:N2}";
                ultraLabelPayedAmountValue.Text = $"? {grandPayed:N2}";
            ...
            catch (Exception ex)
            {
                ...
                ultraLabelTotalPurchasesValue.Text = "0";
                ultraLabelSubTotalValue.Text = "? 0.00";
                ultraLabelGrandTotalValue.Text = "? 0.00";
                ultraLabelPayedAmountValue.Text = "? 0.00";
            }
        }
        #endregion
