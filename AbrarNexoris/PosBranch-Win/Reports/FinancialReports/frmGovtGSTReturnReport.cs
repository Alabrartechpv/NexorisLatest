...
{
    public partial class frmGovtGSTReturnReport : Form
    {
        ...
        private readonly GovtGSTReturnReportRepository _repository;
        private readonly Dictionary<string, Label> _footerLabels;
        private readonly Dictionary<string, string> _columnAggregations;
        private bool _isLoading;

        public frmGovtGSTReturnReport()
        {
            _repository = new GovtGSTReturnReportRepository();
            ...
            Load += frmGovtGSTReturnReport_Load;
            ...
            KeyPreview = true;
            KeyDown += frmGovtGSTReturnReport_KeyDown;
        }

        private void frmGovtGSTReturnReport_Load(object sender, EventArgs e)
        {
            InitializeForm();
        }
        ...
        private void InitializeForm()
        {
            ...
            try
            {
                Text = "Government GST Return Report";
        ...
        private void InitializeFilterControls()
        {
            ...
            ultraComboReportView.Items.Add("GSTR1", "GSTR-1 Working Report");
            ultraComboReportView.Items.Add("GSTR3B", "GSTR-3B Working Report");
            ultraComboReportView.Items.Add("LIABILITY", "GST Liability & ITC Utilization");
            ultraComboReportView.Items.Add("EXECUTIVE", "Monthly GST Executive Summary");
            ultraComboReportView.Value = "GSTR1";
        ...
        private void SetupGrid()
        {
            ...
            layout.GroupByBox.Prompt = "Drag a column header here to group by return section or category";
        ...
        private void LoadReport()
        {
            ...
            try
            {
                GovtGSTReturnFilter filter = new GovtGSTReturnFilter
                {
        ...
        private void btnExportGrid_Click(object sender, EventArgs e)
        {
            try
            {
                using (SaveFileDialog dialog = new SaveFileDialog())
                {
                    ...
                    dialog.FileName = $"Govt_GST_Return_Report_{DateTime.Now:yyyyMMdd_HHmmss}.csv";
        ...
        private void frmGovtGSTReturnReport_KeyDown(object sender, KeyEventArgs e)
        {
