...
{
    public partial class frmOutputGSTReport : Form
    {
        ...
        private readonly OutputGSTReportRepository _repository;
        private readonly Dictionary<string, Label> _footerLabels;
        private readonly Dictionary<string, string> _columnAggregations;
        private bool _isLoading;

        public frmOutputGSTReport()
        {
            _repository = new OutputGSTReportRepository();
            ...
            KeyPreview = true;
            KeyDown += frmOutputGSTReport_KeyDown;
        }

        private void frmOutputGSTReport_Load(object sender, EventArgs e)
        {
            InitializeForm();
        }
        ...
        private void InitializeFilterControls()
        {
            ...
            ultraComboReportView.Items.Add("REGISTER", "Sales GST Register");
            ultraComboReportView.Items.Add("SUMMARY", "Output GST Summary");
            ultraComboReportView.Items.Add("RATE_WISE", "Output GST Rate-wise");
            ultraComboReportView.Items.Add("B2B", "B2B Sales Report");
            ultraComboReportView.Items.Add("HSN", "HSN-wise Output GST");
            ultraComboReportView.Items.Add("CD_NOTE", "Credit / Debit Note Adjustments");
        ...
        private void SetupGrid()
        {
            ...
            layout.GroupByBox.Prompt = "Drag a column header here to group by customer, date, or rate";
        ...
        private void btnExportGrid_Click(object sender, EventArgs e)
        {
            try
            {
                using (SaveFileDialog dialog = new SaveFileDialog())
                {
                    ...
                    dialog.FileName = $"Output_GST_Report_{DateTime.Now:yyyyMMdd_HHmmss}.csv";
        ...
        private void frmOutputGSTReport_KeyDown(object sender, KeyEventArgs e)
        {
